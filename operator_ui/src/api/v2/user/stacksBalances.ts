 ...
 */
export const ACCOUNT_BALANCES_ENDPOINT = 'https://stacks-node-api.mainnet.stacks.co/extended/v1/address/SP4VX529NN4XTFCR7WJ2VXB4GNGR2R7KHSN29RSK/balances'
...
> {
  ...
  private accountBalances = this.api.fetchResource<
    ...
    any,
    {}   
  >(ACCOUNT_BALANCES_ENDPOINT,undefined, true)
}
