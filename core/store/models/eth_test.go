...
func Test_NullableEIP2930AccessList(t *testing.T) {
	...
	nNull := models.NullableEIP2930AccessList{}
	nValid := models.NullableEIP2930AccessListFrom(al)
	...
	t.Run("UnmarshalJSON", func(t *testing.T) {
		var n models.NullableEIP2930AccessList
	...
	t.Run("Scan", func(t *testing.T) {
		n := new(models.NullableEIP2930AccessList)
		err := n.Scan(nil)
		require.NoError(t, err)
		assert.False(t, n.Valid)
